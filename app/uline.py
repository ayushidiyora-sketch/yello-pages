"""Uline Products Scraper — product listings from uline.com.
...
ULINE_COLUMNS = pc.PRODUCT_COLUMNS
...
async def run_job(job_id: str, queries: list, limit: int | None = None) -> None:
    from .db import uline_products
    await pc.run(job_id, queries, limit, uline_products)
