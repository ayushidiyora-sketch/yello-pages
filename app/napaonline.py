"""Napaonline Products Scraper — product listings from napaonline.com.
...
NAPAONLINE_COLUMNS = pc.PRODUCT_COLUMNS
...
async def run_job(job_id: str, queries: list, limit: int | None = None) -> None:
    from .db import napaonline_products
    await pc.run(job_id, queries, limit, napaonline_products)
