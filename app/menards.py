"""Menards Products Scraper — product listings from menards.com.
...
MENARDS_COLUMNS = pc.PRODUCT_COLUMNS
...
async def run_job(job_id: str, queries: list, limit: int | None = None) -> None:
    from .db import menards_products
    await pc.run(job_id, queries, limit, menards_products)
