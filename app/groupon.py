"""Groupon Products Scraper — product listings from groupon.com.
...
GROUPON_COLUMNS = pc.PRODUCT_COLUMNS
...
async def run_job(job_id: str, queries: list, limit: int | None = None) -> None:
    from .db import groupon_products
    await pc.run(job_id, queries, limit, groupon_products)
