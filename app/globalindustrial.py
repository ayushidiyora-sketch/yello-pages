"""Globalindustrial Products Scraper — product listings from globalindustrial.com.
...
GLOBALINDUSTRIAL_COLUMNS = pc.PRODUCT_COLUMNS
...
async def run_job(job_id: str, queries: list, limit: int | None = None) -> None:
    from .db import globalindustrial_products
    await pc.run(job_id, queries, limit, globalindustrial_products)
