"""Northerntool Products Scraper — product listings from northerntool.com.
...
NORTHERNTOOL_COLUMNS = pc.PRODUCT_COLUMNS
...
async def run_job(job_id: str, queries: list, limit: int | None = None) -> None:
    from .db import northerntool_products
    await pc.run(job_id, queries, limit, northerntool_products)
