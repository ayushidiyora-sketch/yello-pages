"""Target Products Scraper — product listings from target.com.
...
TARGET_COLUMNS = pc.PRODUCT_COLUMNS
...
async def run_job(job_id: str, queries: list, limit: int | None = None) -> None:
    from .db import target_products
    await pc.run(job_id, queries, limit, target_products)
