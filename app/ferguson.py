"""Ferguson Products Scraper — product listings from ferguson.com.
...
FERGUSON_COLUMNS = pc.PRODUCT_COLUMNS
...
async def run_job(job_id: str, queries: list, limit: int | None = None) -> None:
    from .db import ferguson_products
    await pc.run(job_id, queries, limit, ferguson_products)
