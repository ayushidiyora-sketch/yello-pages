"""Decathlon Products Scraper — product listings from decathlon.com.
...
DECATHLON_COLUMNS = pc.PRODUCT_COLUMNS
...
async def run_job(job_id: str, queries: list, limit: int | None = None) -> None:
    from .db import decathlon_products
    await pc.run(job_id, queries, limit, decathlon_products)
