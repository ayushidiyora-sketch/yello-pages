"""Cdw Products Scraper — product listings from cdw.com.
...
CDW_COLUMNS = pc.PRODUCT_COLUMNS
...
async def run_job(job_id: str, queries: list, limit: int | None = None) -> None:
    from .db import cdw_products
    await pc.run(job_id, queries, limit, cdw_products)
